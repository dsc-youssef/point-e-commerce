...
import { setTabName } from "@/redux/global/slicers/layout";
// Config
          ...
          <Dropdown>
            ...
            <Dropdown.Menu className="shadow select-none">
              <div className="flex flex-col">
                <Link className="dropdown-item hover:bg-warning hover:text-white font-medium transition" to={`${LAYOUT.dashboard_url}profile`}  onClick={()=> dispatch(setTabName("Profile"))}>
                  <i className="fal fa-user" />
                  Profile
                </Link>
                <div className="dropdown-item hover:bg-success hover:text-white font-medium transition" >
                  <i className="fal fa-calculator-simple" />
                  Tools
                </div>
                <div className="dropdown-item hover:bg-danger hover:text-white font-medium transition" >
