    ...
    <>
      {
        angles ? (
          <div className="inline-flex justify-between items-center pt-5">
            <h1 className=" pb-[10px] px-0 font-bold text-h3 border-b border-b-web-primary-600 w-fit mb-5">{title}</h1>
          ...
          <h1 className="pt-5 pb-[10px] px-0 font-bold text-h3 border-b border-b-web-primary-600 w-fit mb-5">{title}</h1>
        )
      }
    </>
  )
