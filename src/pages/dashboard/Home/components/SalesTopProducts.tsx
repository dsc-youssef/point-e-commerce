    ...
    <div className="card card-container h-full">
      ...
      <div className="card-body grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-3">
        <article className="card">
          <div className="px-3 py-3 flex items-center gap-6  bg-dash-danger/30 rounded">
            <img src={watchImage} className="avatar avatar-md" />
            <div className="flex flex-col justify-center">
              <h1 className="text-md font-semibold">Smart Watch</h1>
              <p className="bg-dash-danger text-xs text-white font-medium px-2 py-1 rounded w-fit">$500</p>
            </div>
          </div>
        </article>
        <article className="card">
          <div className="px-3 py-3  flex items-center gap-6  bg-dash-success/30 rounded">
            <img src={controllerImage} className="avatar avatar-md" />
            <div className="flex flex-col justify-center">
              <h1 className="text-md font-semibold">PS4 Controller</h1>
              <p className="bg-dash-success text-xs text-white font-medium px-2 py-1 rounded w-fit">$340</p>
            </div>
          </div>
        </article>
        <article className="card">
          <div className="px-3 py-3 flex items-center gap-6  bg-dash-warning/30 rounded">
            <img src={cameraImage} className="avatar avatar-md" />
            <div className="flex flex-col justify-center">
              <h1 className="text-md font-semibold">Camera</h1>
              <p className="bg-dash-warning text-xs text-white font-medium px-2 py-1 rounded w-fit">$340</p>
            </div>
          </div>
        </article>
        <article className="card">
          <div className="px-3 py-3  flex items-center gap-6  bg-dash-secondary/30 rounded">
            <img src={laptopImage} className="avatar avatar-md" />
            <div className="flex flex-col justify-center">
              <h1 className="text-md font-semibold">Laptop</h1>
              <p className="bg-dash-secondary text-xs text-white font-medium px-2 py-1 rounded w-fit">$340</p>
            </div>
          </div>
        </article>
        <article className="card h-full">
          <div className="px-3 py-3 flex items-center gap-6  bg-dash-primary/30 rounded">
            <img src={iphoneImage} className="avatar avatar-md" />
            <div className="flex flex-col justify-center">
              <h1 className="text-md font-semibold">Iphone</h1>
              <p className="bg-dash-primary text-xs text-white font-medium px-2 py-1 rounded w-fit">$340</p>
            </div>
          </div>
        </article>
      </div>
